      ...
      <div className="w-full max-w-md p-8 bg-brand-surface-dark rounded-2xl border border-brand-surface-border">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3 bg-black text-white font-medium rounded-lg border border-gray-300
              hover:bg-gray-900 transition-all duration-200 flex items-center justify-center gap-3 mt-3"
          >
